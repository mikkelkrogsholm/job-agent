...
- **Betinget:** Jobagenten tilbyder fire feature-flagstyrede, read-only WebMCP-site tools. De registreres kun, når siden, appen, kontoen og modellen understøtter dem, og serveren har aktiveret funktionen.
...
## Kopiér til ChatGPT Desktop

> Åbn Jobagenten i den indbyggede browser og fortæl, om du faktisk kan se fire read-only site tools: capabilities, guide, jobsøgning og jobdetaljer. Hvis de findes, brug capabilities og lav én søgning efter “kommunikationsmedarbejder Aarhus” med originale URL'er. Hvis ikke, brug Markdown-guiden eller en manuel portalsøgning. Brug aldrig browser- eller computerstyring til login, kontakt eller afsendelse.

## Når opsætningen virker

Du er færdig, når fire site tools er observeret og en read-only søgning har kilder — eller når den manuelle fallback er klar uden at love WebMCP.

## Det tjekker du selv

- Er du i ChatGPT Desktops indbyggede browser og ikke almindelig Chrome?
- Viser værktøjerne read-only-grænsen og ubetroet annonceindhold?
- Stopper arbejdsgangen før login og sendeknap?

## Næste skridt

Vælg dit trin i [jobsøgerforløbet](/forloeb/) eller brug [promptbiblioteket](/prompts/).
